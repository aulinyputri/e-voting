        ...
        <div class="card-header py-3">
            <div class="row">
                ...
                <div class="col-md-8 d-flex justify-content-end">
                    <a href="/admin/visimisi/create" class="btn bg-gradient-primary text-white btn-sm ml-1">
                        <i class="fas fa-plus-square"></i> Tambah Data {{ ucfirst(request()->segment(2)) }}
                    </a>
                    <a href="/admin/visimisi/truncate" class="btn bg-gradient-primary text-white btn-sm ml-1"
                ...
                <table class="table table-bordered table-hover table-sm" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->kandidat->nama_kandidat . ' - ' . $item->kandidat->nama_calon }}</td>
                            <td>{{ $item->visi }}</td>
                            <td>{{ $item->misi }}</td>
                            <td>
                                <a href="/admin/visimisi/{{ $item->id }}/edit"
                                    class="btn bg-gradient-warning text-white btn-sm">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                                <a href="/admin/visimisi/{{ $item->id }}/destroy"
