...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="/admin/kandidat/" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_kandidat" id="nama_kandidat"
                            ...
                            value="{{ old('nama_kandidat') }}" required>
                        @error('nama_kandidat')
                    ...
                    <button type="submit" class="btn bg-gradient-primary text-white mt-3">Simpan</button>
