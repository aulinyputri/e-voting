...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="/admin/kandidat/update/{{ $kandidat->kandidat_id }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_calon" id="nama_calon" class="form-control"
                            value="{{ old('nama_calon') == '' ? $kandidat->no_paslon : old('nama_calon') }}" required>
                        @error('nama_calon')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
